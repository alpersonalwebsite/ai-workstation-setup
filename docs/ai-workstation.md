...
The Claude Code material is the middle of this document; the display and
lighting sections at the end are optional and independent of it.

- [Prerequisites](#prerequisites)
  - [Claude Code](#claude-code)
  - [Claude Code settings](#claude-code-settings)
- [Terminal](#terminal)
  - [tmux (+ resurrect, continuum, sensible, yank)](#tmux--resurrect-continuum-sensible-yank)
  - [fzf](#fzf)
...
- [Claude Code config and skills](#claude-code-config-and-skills)
...
- [Habits](#habits)
  - [A `CLAUDE.md` per project](#a-claudemd-per-project)
  - [One tmux session per project](#one-tmux-session-per-project)
- [Window and display management](#window-and-display-management)
  - [Rectangle](#rectangle)
  - [Lunar](#lunar)
  - [displayplacer](#displayplacer)
- [Lighting and eye comfort](#lighting-and-eye-comfort)
  - [BenQ ScreenBar Halo 2 (monitor light bar)](#benq-screenbar-halo-2-monitor-light-bar)
  - [Govee strip (bias / ambient)](#govee-strip-bias--ambient)
  - [Screen brightness and blue light](#screen-brightness-and-blue-light)
  - [Terminal colors](#terminal-colors)
  - [Dark mode across apps and the web](#dark-mode-across-apps-and-the-web)
